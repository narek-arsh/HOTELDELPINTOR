...
class Incidencia(Base):
    ...
    dispositivo_id = Column(String(64), nullable=True, index=True)  # ID local del navegador del huésped
    nota_cliente = Column(Text, nullable=True)  # nota visible para el huésped (distinta del chat interno)
